...
#include "AbilitySystem/ModMagCalc/MMC_HolyResistance.h"

#include "AbilitySystem/TKAttributeSet.h"
#include "Interaction/CombatInterface.h"

UMMC_HolyResistance::UMMC_HolyResistance()
{
...
float UMMC_HolyResistance::CalculateBaseMagnitude_Implementation(const FGameplayEffectSpec& Spec) const
{
	...
	return 5.f + (Devotion * 0.5f) - (Blasphemy * 0.5f) + PlayerLevel * 0.1;
}
